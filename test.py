...
def wins(state, player):
 ...
 [state[1][1], state[2][2], state[3][3], state[4][4]],
 [state[1][2], state[2][2], state[3][2], state[4][2]],
 [state[1][3], state[2][3], state[3][3], state[4][3]],
 [state[1][4], state[2][4], state[3][4], state[4][4]],
 ...
 [state[4][0], state[3][1], state[2][2], state[1][3]],
 [state[4][1], state[4][2], state[4][3], state[4][4]],
 [state[4][1], state[3][2], state[2][3], state[1][4]]]
...
def main():
    ...
    while grilles % 2 == 0 or grilles==1:
        try:
            print('')
